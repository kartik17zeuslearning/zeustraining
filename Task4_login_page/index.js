...
function printAlertData() {
    return __awaiter(this, void 0, void 0, function () {
        var alertData, alertDiv, i, alertMessage, alertHead, title, status_1, alertTopic, alertTopic, alertDate, alertButton;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
function printAnnouncementData() {
    return __awaiter(this, void 0, void 0, function () {
        var announcementData, announcementDiv, i, announcementMessage, announcementName, name_1, announcementHead, title, status_2, announcementTopic, announcementTopic, announcementDate, attachFile, date, announceDate, announcementButton, showAllBtn, announceDivider, createNewBtn;
        return __generator(this, function (_a) {
            switch (_a.label) {
